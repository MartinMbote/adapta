...
const Protectedarea = () => {
  return (
    <div>
        <div className='bg-white w-[17.4vw] h-[11.3vw] text-adapta-blue font-semibold text-[0.8vw] leading-[1vw] pt-[1.3vw] pb-[0.9vw] px-[1vw] rounded-[0.4vw] border-[0.15vw] border-adapta-grey mt-[1vw]'>
            <p>
